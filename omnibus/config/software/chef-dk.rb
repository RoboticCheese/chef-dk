...
build do
  ...
  appbundle "foodcritic", lockdir: project_dir, env: env
  appbundle "ohai", lockdir: project_dir, env: env
  appbundle "test-kitchen", lockdir: project_dir, env: env
  appbundle "opscode-pushy-client", lockdir: project_dir, env: env
  appbundle "cookstyle", lockdir: project_dir, env: env
  appbundle "rubocop", lockdir: project_dir, env: env
